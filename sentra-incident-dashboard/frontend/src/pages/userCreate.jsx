...
const UserCreationForm = ({ onToggleMode, mode }) => {
          ...
          <Fade in timeout={600}>
            ...
            >
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <Grid container spacing={1.5} alignItems="flex-end">
                      {/* User Role Field - Takes less space */}
                      <Grid item xs={5}>
                        <Typography variant="caption" sx={{ 
                          fontWeight: 600, 
                          mb: 0.5, 
                        ...
                        <FormControl fullWidth variant="outlined" size="small">
                          ...
                          >
                            <MenuItem value="student" sx={{ fontSize: '0.875rem' }}>
                            ...
                            <MenuItem value="staff" sx={{ fontSize: '0.875rem' }}>
                              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                <Box sx={{ 
                                  width: 6, 
                                  height: 6, 
              ...
              <Box sx={{ 
                ...
                >
                  User will receive account credentials and can login immediately
                </Typography>
              </Box>
            </Paper>
          </Fade>
