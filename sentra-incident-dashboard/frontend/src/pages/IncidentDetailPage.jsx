...
const IncidentDetailPage = () => {
  ...
  const canEdit = () => {
    ...
    // Anonymous incidents cannot be edited
    ...
    if (incident.reporter) {
      const reporterId = incident.reporter.id || incident.reporter._id;
      console.log('Reporter ID:', reporterId);
      console.log('User ID:', user.id);
      console.log('Match:', reporterId === user.id);
      return reporterId === user.id;
    }
    
    console.log('Cannot edit: No reporter found');
    return false;
  };
